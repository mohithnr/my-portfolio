    ...
    <>
      <style>
        {`
          ...
          /* Waving text animation for heading */
          .animated-text span {
      ...
      >
        <div className="contact-container">
          {/* Section Header with waving text */}
          <div className="section-header slide-in-left">
            <h2 className="section-label">06.</h2>
            <h3
              aria-label="Get In Touch"
              className="section-heading animated-text"
            ...
            >
              <p
                style={{
                  ...
                  lineHeight: "1.6",
                  fontFamily:
                    "'Inter', 'San Francisco', 'SF Pro Display', -apple-system, system-ui, sans-serif",
                  fontWeight: "400",
                  margin: "0 0 30px 0",
                  maxWidth: "600px",
                  marginLeft: "auto",
